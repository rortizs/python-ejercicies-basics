"""Cuadernillo 0 - UML y Relaciones - Tema 13: Polimorfismo: tratar objetos distintos de forma uniforme."""
...
for usuario in usuarios:
    print(usuario.describir())  # cada objeto ejecuta SU propia version
