...
try: # Usa raise para levantar un error
...
nuestro_iterator.**next**() #=> "uno"

# Mantiene el estado mientras llamamos **next**

nuestro_iterator.**next**() #=> "dos"
nuestro_iterator.**next**() #=> "tres"

# Después que el iterador ha retornado todos sus datos, da una excepción StopIterator

nuestro_iterator.**next**() # Genera StopIteration
...
mensaje = "¿Puedes comprarme una Coca-cola?"
return mensaje, decir_por_favor

print(decir()) # ¿Puedes comprarme una Coca-cola?
print(decir(decir_por_favor=True)) # ¿Puedes comprarme una Coca-cola? ¡Por favor! Soy pobre :(
