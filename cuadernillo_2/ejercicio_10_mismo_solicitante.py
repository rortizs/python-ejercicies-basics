"""Cuadernillo II - Ejercicio 10: Comparar dos tickets por atributo."""
...
def main() -> None:
    ticket_a = Ticket(1, "Ana Lopez", "ALTA")
    ticket_b = Ticket(2, "Ana Lopez", "MEDIA")
    ticket_c = Ticket(3, "Luis Perez", "BAJA")

    print(ticket_a.mismo_solicitante(ticket_b))
    print(ticket_a.mismo_solicitante(ticket_c))
