"""Cuadernillo II - Ejercicio 13: Clase GestorTickets que encapsula la colección."""
...
def main() -> None:
    ...
    gestor.agregar_ticket(Ticket(2, "Luis Perez", "MEDIA"))

    gestor.listar_tickets()

    encontrado = gestor.buscar_por_id(1)
    print(encontrado)

    no_encontrado = gestor.buscar_por_id(99)
    print(no_encontrado)
